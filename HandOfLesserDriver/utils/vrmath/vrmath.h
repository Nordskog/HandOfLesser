...
HmdQuaternion_FromSwingTwist(const vr::HmdVector2_t& swing, const float twist)
{
...
static vr::HmdVector3_t operator*(const vr::HmdVector3_t& vec, const vr::HmdQuaternion_t& q)
{
	...
	return {
		static_cast<float>(qResult.x),
		static_cast<float>(qResult.y),
		static_cast<float>(qResult.z)};
}
